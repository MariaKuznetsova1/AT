...
public class TestsForQuadrate extends Parent {
	...
	public void testGetQuadrate(@Optional ("") double sideOfASquareFromXML) {
	...
	public void testGetPerimeter(@Optional ("") double sideOfASquareFromXML) {
	...
	public void testGetSquare(@Optional ("") double sideOfASquareFromXML) {
